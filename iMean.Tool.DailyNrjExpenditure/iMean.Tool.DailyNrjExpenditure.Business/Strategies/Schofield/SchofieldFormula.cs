...
public class SchofieldFormula : ISchofieldFormula
{
    private readonly SchofieldFormulaConstants _constants;

    public SchofieldFormula(SchofieldFormulaConstants constants)
    {
